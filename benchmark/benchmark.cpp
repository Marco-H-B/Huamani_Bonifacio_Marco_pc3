...
int main() {
    ...
    for (int i = 0; i < Q; i++) {
        ...
        int x = (rand() % 2000000000) - 1000000000; // rango de -10^9 a 10^9 (como pide SPOJ)
    ...
    // limpiar todo para no tener leak
    // aunque al final del programa el SO limpia la memoria, es buena practica
    return 0;
}
